  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 mr-4 md:flex-1">
        ...
        <span className="text-[18px] md:text-[20px] leading-none shrink-0" style={{ fontFamily: "var(--font-serif)" }}>
      ...
      <nav aria-label="Hauptnavigation" className="flex items-center gap-4 md:gap-8 overflow-x-auto no-scrollbar py-2">
      ...
      <div className="flex-1 flex justify-end ml-4">
        <Button size="sm" className="gap-1.5 text-[12px] md:text-[13px] px-3 md:px-4">
