...
// Three batches of 5. After each batch the user can see results or continue.
// Ordered by scoring impact — most impactful questions come first.
export const WIZARD_BATCHES: [WizardStep[], WizardStep[], WizardStep[]] = [
  // ── Batch 1: Core ────────────────────────────────────────────────────────
  [
    {
      id: "audience",
  ...
  [
    ...
    {
      id: "limitations",
      title: "Gibt es körperliche Einschränkungen?",
      type: "multi",
      options: [
